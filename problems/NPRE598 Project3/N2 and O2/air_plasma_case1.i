...
# 3. Type "../../../crane-opt -i air_plasma_case1.i".
#    air_plasma_case1_output.csv should be created in the folder.
  ...
  [air_reactions]
    ...
    reactions = '
		 ...
		 # 16
     		 ...
     		 # 7 (R4)
                 e + N2 -> N2+ + e + e        : {1.00e-10*(1.5*T_e/11605)^(1.90)*exp(-14.6/(1.5*T_e/11605))}
     		 # 18 (R60)
